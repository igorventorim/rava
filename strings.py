...
class Strings():
    ...
    APRESENTATION= "Eu sou o Robô de Auxílio Virtual ao Aprendizado, para os mais íntimos Rava.\n Eu auxílio o ensino virtual recebendo perguntas enviadas por professores e encaminhando para os alunos e corrigindo as respostas dos alunos, o que você deseja fazer?"
    BACK = u"Voltar"
